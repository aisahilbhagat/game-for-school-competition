window.Level7 = {
    ...
    init: function(engine) {
        this.engine = engine;
        console.log("Level 7 Initialized");
    },

    load: function() {
        console.log("Level 7: Triggering Character Load...");
    ...
    setupLevel: function() {
        console.log("Level 7 Setup Complete.");
    },
    ...
    render: function(ctx) {
        ...
        ctx.fillText("LEVEL 7 - Use Arrow Keys / WASD", 20, 30);
    }
};