window.Level9 = {
    ...
    init: function(engine) {
        this.engine = engine;
        console.log("Level 9 Initialized");
    },

    load: function() {
        console.log("Level 9: Triggering Character Load...");
    ...
    setupLevel: function() {
        console.log("Level 9 Setup Complete.");
    },
    ...
    render: function(ctx) {
        ...
        ctx.fillText("LEVEL 9 - Use Arrow Keys / WASD", 20, 30);
    }
};